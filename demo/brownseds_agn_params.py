...
run_params = {'verbose': True,
              'debug': False,
              'outfile': 'brown_data/results/brownseds_agn',
              'nofork': True,
              # Optimizer params
              'ftol': 0.5e-5, 
              'maxfev': 5000,
              ...
              # Data info
              'datname': 'brown_data/table1.fits',
              'photname': 'brown_data/table3.txt',
              'extinctname': 'brown_data/table4.fits',
              'herschname': 'brown_data/kingfish.brownapertures.flux.fits',
              'objname': 'Arp 256 N',
              }
...
def load_model(objname='',datname='', agelims=[], **extras):
    ...
    idx = [objname in name for name in hdulist[1].data['Name']]
